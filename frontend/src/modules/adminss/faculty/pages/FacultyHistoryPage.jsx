// src/modules/faculty/pages/FacultyHistoryPage.jsx
...
export default function FacultyHistoryPage() {
  ...
  const load = async () => {
    setLoading(true);
    try {
      const r = await axiosInstance.get(EP.audit.list, { params: { module: "faculty", page, limit } });
  ...
  return (
    <div className="max-w-5xl space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div><h1 className="text-xl font-bold">Faculty History</h1><p className="text-sm text-muted-foreground">{total} audit entries</p></div>
      </div>
