...
import { TableShell, RowActions, Th, Td, EmptyRow, LoadingRow, ConfirmModal, Spinner } from "../../../../components/shared/AcademicPage.jsx";
...
export default function SubjectsPage() {
  ...
  // Deep-link support: /admin/subjects/list?action=create opens the modal directly
  useEffect(() => {
