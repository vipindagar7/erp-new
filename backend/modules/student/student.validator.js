...
const studentBase = z.object({
  ...
  // Contact
  contact_number: z.string().min(1).optional().nullable(),
  alt_contact_number: z.string().optional().nullable(),
  personal_email: z.string().email().optional().nullable(),
  // Parents
  father_name: z.string().min(1).optional().nullable(),
  mother_name: z.string().min(1).optional().nullable(),
  father_mobile: z.string().optional().nullable(),
  mother_mobile: z.string().optional().nullable(),
  // Personal
  gender: z.string().optional().nullable().transform(v => ["MALE", "FEMALE", "OTHER"].includes(v) ? v : null),
